...
namespace SS.ScriptableObjects
{
    ...
    public class SSNodeContainerSO : ScriptableObject
    {
        ...
        public void Initialize(string fileName, string id, SSStoryStatus storyStatus, SSStoryType storyType, SSSpontaneousType spontaneousType, bool isTutorialToPlay, bool isFirstToPlay, bool isReplayable, ConditionSO condition)
        {
            FileName = fileName;
            ID = id;
