...
namespace SS.Utilities
{
    ...
    public static class SSIOUtility
    {
        ...
        public static void Save()
        {
            ...
            graphData.Initialize(graphFileName, graphView.ID, graphView.StoryStatus, graphView.StoryType, graphView.IsFirstToPlay,
                graphView.Condition);

            SSNodeContainerSO nodeContainer = CreateAsset<SSNodeContainerSO>(containerFolderPath, graphFileName);

            nodeContainer.Initialize(graphFileName, graphView.ID, graphView.StoryStatus, graphView.StoryType, graphView.IsFirstToPlay,
                graphView.Condition);
