...
public class Dialogue : MonoBehaviour
{
    ...
    public void DisplayDialogue(Sprite characterSprite, string characterName, SSDialogueNodeSO node, float duration)
    {
        durationDestroy = durationBeforeDestroy * TimeTickSystem.ticksPerHour;
        characterImage.sprite = characterSprite;
        characterNameText.text = characterName;
        nodeSO = node;
        this.duration = durationToDisplay * TimeTickSystem.ticksPerHour;
    ...
    private IEnumerator Fade()
    {
        ...
        {
            characterImage.color = new Color(characterImage.color.r, characterImage.color.g, characterImage.color.b, characterImage.color.a - 0.01f);
            characterNameText.color = new Color(characterNameText.color.r, characterNameText.color.g, characterNameText.color.b, characterNameText.color.a - 0.1f);
            dialogueText.color = new Color(dialogueText.color.r, dialogueText.color.g, dialogueText.color.b, dialogueText.color.a - 0.1f);
